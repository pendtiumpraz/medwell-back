...
<div class="flex h-screen overflow-hidden">
    <div class="flex-1 overflow-y-auto p-6 bg-gray-50">
        <div class="max-w-2xl">
            <div class="mb-4">
                ...
                <p class="text-gray-600 text-sm mt-1">Add a new department to a facility</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full md:w-[500px] bg-white shadow-2xl overflow-y-auto border-l border-gray-200">
        ...
        <form action="{{ route('super-admin.departments.store') }}" method="POST" class="p-4 space-y-4">
            @csrf
            ...
            <div class="flex gap-2 pt-3 sticky bottom-0 bg-white pb-3 border-t border-gray-200 -mx-4 px-4">
                ...
                <a href="{{ route('super-admin.departments.index') }}" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-lg text-center transition-all text-sm">
